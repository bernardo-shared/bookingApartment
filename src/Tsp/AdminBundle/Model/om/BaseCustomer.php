...
abstract class BaseCustomer extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Tsp\\AdminBundle\\Model\\CustomerPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CustomerPeer::USERNAME)) {
     ...
     * @return PropelObjectCollection|Booking[] List of Booking objects
     */
    public function getBookingsJoinBed($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = BookingQuery::create(null, $criteria);
        $query->joinWith('Bed', $join_behavior);
