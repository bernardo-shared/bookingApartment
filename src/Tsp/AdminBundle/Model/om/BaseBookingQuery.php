 ...
 * @method BookingQuery orderByStartDate($order = Criteria::ASC) Order by the start_date column
 * @method BookingQuery orderByEndDate($order = Criteria::ASC) Order by the end_date column
 * @method BookingQuery orderByCustomerId($order = Criteria::ASC) Order by the customer_id column
 * @method BookingQuery orderByBedId($order = Criteria::ASC) Order by the bed_id column
 *
 * @method BookingQuery groupById() Group by the id column
 * @method BookingQuery groupByStartDate() Group by the start_date column
 * @method BookingQuery groupByEndDate() Group by the end_date column
 * @method BookingQuery groupByCustomerId() Group by the customer_id column
 * @method BookingQuery groupByBedId() Group by the bed_id column
 *
 ...
 *
 * @method BookingQuery leftJoinBed($relationAlias = null) Adds a LEFT JOIN clause to the query using the Bed relation
 * @method BookingQuery rightJoinBed($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Bed relation
 * @method BookingQuery innerJoinBed($relationAlias = null) Adds a INNER JOIN clause to the query using the Bed relation
 *
 ...
 *
 * @method Booking findOneByStartDate(string $start_date) Return the first Booking filtered by the start_date column
 * @method Booking findOneByEndDate(string $end_date) Return the first Booking filtered by the end_date column
 * @method Booking findOneByCustomerId(int $customer_id) Return the first Booking filtered by the customer_id column
 * @method Booking findOneByBedId(int $bed_id) Return the first Booking filtered by the bed_id column
 *
 * @method array findById(int $id) Return Booking objects filtered by the id column
 * @method array findByStartDate(string $start_date) Return Booking objects filtered by the start_date column
 * @method array findByEndDate(string $end_date) Return Booking objects filtered by the end_date column
 * @method array findByCustomerId(int $customer_id) Return Booking objects filtered by the customer_id column
 * @method array findByBedId(int $bed_id) Return Booking objects filtered by the bed_id column
 *
...
abstract class BaseBookingQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Tsp\\AdminBundle\\Model\\Booking', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `start_date`, `end_date`, `customer_id`, `bed_id` FROM `booking` WHERE `id` = :p0';
        try {
    ...
    public function filterByStartDate($startDate = null, $comparison = null)
    {
        if (is_array($startDate)) {
            ...
            if (isset($startDate['min'])) {
                $this->addUsingAlias(BookingPeer::START_DATE, $startDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($startDate['max'])) {
                $this->addUsingAlias(BookingPeer::START_DATE, $startDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::START_DATE, $startDate, $comparison);
    }
    ...
    public function filterByEndDate($endDate = null, $comparison = null)
    {
        if (is_array($endDate)) {
            ...
            if (isset($endDate['min'])) {
                $this->addUsingAlias(BookingPeer::END_DATE, $endDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($endDate['max'])) {
                $this->addUsingAlias(BookingPeer::END_DATE, $endDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::END_DATE, $endDate, $comparison);
    }
    ...
    /**
     * Filter the query on the bed_id column
     *
     * Example usage:
     * <code>
     * $query->filterByBedId(1234); // WHERE bed_id = 1234
     * $query->filterByBedId(array(12, 34)); // WHERE bed_id IN (12, 34)
     * $query->filterByBedId(array('min' => 12)); // WHERE bed_id >= 12
     * $query->filterByBedId(array('max' => 12)); // WHERE bed_id <= 12
     * </code>
     *
     * @see       filterByBed()
     *
     * @param     mixed $bedId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return BookingQuery The current query, for fluid interface
     */
    public function filterByBedId($bedId = null, $comparison = null)
    {
        if (is_array($bedId)) {
            $useMinMax = false;
            if (isset($bedId['min'])) {
                $this->addUsingAlias(BookingPeer::BED_ID, $bedId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($bedId['max'])) {
                $this->addUsingAlias(BookingPeer::BED_ID, $bedId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::BED_ID, $bedId, $comparison);
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Tsp\AdminBundle\Model\CustomerQuery A secondary query class using the current class as primary query
     */
    public function useCustomerQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCustomer($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Customer', '\Tsp\AdminBundle\Model\CustomerQuery');
    }

    /**
     * Filter the query by a related Bed object
     *
     * @param   Bed|PropelObjectCollection $bed The related object(s) to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 BookingQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
    ...
    public function filterByBed($bed, $comparison = null)
    {
        if ($bed instanceof Bed) {
            return $this
                ->addUsingAlias(BookingPeer::BED_ID, $bed->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BookingPeer::BED_ID, $bed->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Tsp\AdminBundle\Model\BedQuery A secondary query class using the current class as primary query
     */
    public function useBedQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinBed($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Bed', '\Tsp\AdminBundle\Model\BedQuery');
    }
