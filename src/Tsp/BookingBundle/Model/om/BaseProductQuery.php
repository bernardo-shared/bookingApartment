...
use \PropelPDO;
use Tsp\BookingBundle\Model\Product;
use Tsp\BookingBundle\Model\ProductPeer;
use Tsp\BookingBundle\Model\ProductQuery;
...
abstract class BaseProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'Tsp\\BookingBundle\\Model\\Product', $modelAlias = null)
    {
