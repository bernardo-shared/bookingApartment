...
class BedTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Tsp.BookingBundle.Model.map.BedTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setName('bed');
        $this->setPhpName('Bed');
        $this->setClassname('Tsp\\BookingBundle\\Model\\Bed');
    ...
    {
        $this->addRelation('Room', 'Tsp\\BookingBundle\\Model\\Room', RelationMap::MANY_TO_ONE, array('room_id' => 'id', ), null, null);
        $this->addRelation('Booking', 'Tsp\\BookingBundle\\Model\\Booking', RelationMap::ONE_TO_MANY, array('id' => 'bed_id', ), null, null, 'Bookings');
    } // buildRelations()
