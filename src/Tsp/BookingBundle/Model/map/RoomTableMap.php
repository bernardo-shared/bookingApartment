...
class RoomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Tsp.BookingBundle.Model.map.RoomTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Tsp\\BookingBundle\\Model\\Room');
    ...
    {
        $this->addRelation('Flat', 'Tsp\\BookingBundle\\Model\\Flat', RelationMap::MANY_TO_ONE, array('flat_id' => 'id', ), null, null);
        $this->addRelation('Bed', 'Tsp\\BookingBundle\\Model\\Bed', RelationMap::ONE_TO_MANY, array('id' => 'room_id', ), null, null, 'Beds');
    } // buildRelations()
