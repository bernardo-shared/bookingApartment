...
class BookingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Tsp.BookingBundle.Model.map.BookingTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Tsp\\BookingBundle\\Model\\Booking');
    ...
    {
        $this->addRelation('Customer', 'Tsp\\BookingBundle\\Model\\Customer', RelationMap::MANY_TO_ONE, array('customer_id' => 'id', ), null, null);
        $this->addRelation('Bed', 'Tsp\\BookingBundle\\Model\\Bed', RelationMap::MANY_TO_ONE, array('bed_id' => 'id', ), null, null);
    } // buildRelations()
